...
function calculateScoreSoftware() {
    ...
    const skillsS = ['jsSkill', 'pythonSkill', 'javaSkill', 'cppSkill', 'htmlCssSkill', 'rubySkill', 'swiftSkill', 'phpSkill', 'goSkill', 'rustSkill', 'typescriptSkill', 'kotlinSkill', 'scalaSkill', 'haskellSkill', 'Experience'];
